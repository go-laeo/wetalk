...
func (cu *CommentUpdate) SetToID(id int) *CommentUpdate {
	cu.mutation.SetToID(id)
	return cu
}

// SetNillableToID sets the "to" edge to the User entity by ID if the given value is not nil.
func (cu *CommentUpdate) SetNillableToID(id *int) *CommentUpdate {
	if id != nil {
		cu = cu.SetToID(*id)
	}
	return cu
...
func (cu *CommentUpdate) SetTo(u *User) *CommentUpdate {
	return cu.SetToID(u.ID)
}
...
func (cu *CommentUpdate) ClearTo() *CommentUpdate {
	cu.mutation.ClearTo()
	return cu
}
...
func (cu *CommentUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if cu.mutation.ToCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   comment.ToTable,
			Columns: []string{comment.ToColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: &sqlgraph.FieldSpec{
					Type:   field.TypeInt,
	...
	if nodes := cu.mutation.ToIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   comment.ToTable,
...
// SetToID sets the "to" edge to the User entity by ID.
func (cuo *CommentUpdateOne) SetToID(id int) *CommentUpdateOne {
	cuo.mutation.SetToID(id)
	return cuo
}

// SetNillableToID sets the "to" edge to the User entity by ID if the given value is not nil.
func (cuo *CommentUpdateOne) SetNillableToID(id *int) *CommentUpdateOne {
	if id != nil {
		cuo = cuo.SetToID(*id)
	}
	return cuo
...
// SetTo sets the "to" edge to the User entity.
func (cuo *CommentUpdateOne) SetTo(u *User) *CommentUpdateOne {
	return cuo.SetToID(u.ID)
}
...
// ClearTo clears the "to" edge to the User entity.
func (cuo *CommentUpdateOne) ClearTo() *CommentUpdateOne {
	cuo.mutation.ClearTo()
	return cuo
}
...
func (cuo *CommentUpdateOne) sqlSave(ctx context.Context) (_node *Comment, err error) {
	...
	if nodes := cuo.mutation.ToIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   comment.ToTable,
